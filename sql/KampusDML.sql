insert into
    type_dosen (kode_type_dosen, deskripsi)
values
    ('T001', 'Tetap'),
    ('T002', 'Honorer'),
    ('T003', 'Expertise');
...
insert into
    ujian (kode_ujian, nama_ujian, status_ujian)
values
...
insert into
    jurusan (kode_jurusan, nama_jurusan, status_jurusan)
values
...
values
    ...
    (
        'M002',
        'Rinto Raharjo',
        'Jl. Kebagusan No. 33 RT04 RW06 Bandung',
        'A002',
        'J002'
    ),
    (
        'M003',
        'Asep Saepudin',
        'Jl. Sumatera No. 12 RT02 RW01, Ciamis',
        'A001',
        'J003'
    ),
    (
        'M004',
        'M. Hafif Isbullah',
        'Jl. Jawa No 01 RT01 RW01, Jakarta Pusat',
        'A001',
        'J001'
    ),
    (
        'M005',
        'Cahyono',
        'Jl. Niagara No. 54 RT01 RW09, Surabaya',
        'A003',
        'J002'
    );

insert into
    nilai (kode_mahasiswa, kode_ujian, nilai)
values
    ('M004', 'U001', 90),
    ('M001', 'U001', 80),
    ('M002', 'U003', 85),
